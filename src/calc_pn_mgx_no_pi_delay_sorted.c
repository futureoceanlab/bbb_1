...
/*!
Does MGX mode PN modulation no Pi delay ( DCS0, DCS1)  image acquisition and returns sorted distance/amplitude data array
 ...
 */
int calcPNMGXNoPiDelayGetDataSorted(enum calculationType type, uint16_t **data) {
